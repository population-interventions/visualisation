...
var strategies = {
		"Elimination": {
			...
			transitions: [
				...
				{ from: "1",		to: "2", 	trigger: "7-day average > 1" },
				{ from: "1b",		to: "2", 	trigger: "7-day average > 1" },
				{ from: "1",		to: "1b", 	trigger: "7-day average > 0.286" },
		...
		"Bare Suppression": {
			...
			description: "Aim for < 500 new cases per million people per day.",
			examples: "~ UK during July 2021",
			transitions: [
				{ from: "1",		to: "4", 	trigger: "7-day average > 2000/mill." },
				{ from: "1b",		to: "4", 	trigger: "7-day average > 2000/mill." },
				{ from: "2",		to: "4", 	trigger: "7-day average > 2000/mill." },
				{ from: "3",		to: "4", 	trigger: "7-day average > 2000/mill." },
				{ from: "1",		to: "3", 	trigger: "7-day average > 500/mill." },
				{ from: "1b",		to: "3", 	trigger: "7-day average > 500/mill." },
				{ from: "2",		to: "3", 	trigger: "7-day average > 500/mill." },
				// { from: "1",		to: "2", 	trigger: "2+ cases in last 14 days" },
				{ from: "1b",		to: "2", 	trigger: "7-day average > 100/mill." },
				{ from: "1",		to: "1b", 	trigger: "7-day average > 100/mill." },
				{ from: "4",		to: "3", 	trigger: "7-day average < 350/mill." },
				{ from: "3",		to: "2", 	trigger: "7-day average < 100/mill." },
				{ from: "2",		to: "1", 	trigger: "7-day average < 50/mill." },
				{ from: "1b",		to: "1", 	trigger: "7-day average < 50/mill." },
				{ from: "1",		to: "1", 	trigger: "" },
				{ from: "1b",		to: "1b", 	trigger: "" },
				{ from: "2",		to: "2", 	trigger: "" },
				{ from: "3",		to: "3", 	trigger: "" },
